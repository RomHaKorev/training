...
\begin{frame}{What about unit tests ?}
  \begin{center}
    \begin{tikzpicture}
      \drawsystem
      \begin{scope}[decoration=snake,alert_color,thick]
...
\begin{frame}{What about unit tests ?}
  \begin{center}
    \begin{tikzpicture}
      \drawsystem
      \begin{scope}[thick,alert_color]
        \node[circle,draw,fit=(backend.north) (frontend.south)] {};
        \node[circle,draw,fit=(backend.south) (db.north)] {};
      \end{scope}
    \end{tikzpicture}
  \end{center}
\end{frame}
...
\begin{frame}{What about unit tests ?}
  \begin{center}
    \begin{tikzpicture}
      \drawsystem
      \begin{scope}[thick,alert_color]
        \node[ellipse,draw,rotate fit=40,fit=(backend.center) (db)] {};
        \node[ellipse,draw,fit=(backend.center) (bus)] {};
        \node[ellipse,draw,fit=(backend.center) (partners)] {};
        \node[circle,draw,fit=(backend.center) (frontend.center) (bus.center)] {};
      \end{scope}
    \end{tikzpicture}
  \end{center}
\end{frame}
...
\begin{frame}{What about unit tests ?}
  \begin{center}
    \begin{tikzpicture}
      \drawsystem
      \begin{scope}[decoration={snake,amplitude=1},draw=alert_color,thick]
